...
l'utente che voglia iscriversi sia consapevole dell'esistenza dell'appello così da potersi iscrivere*/
    ...
    $query = 'SELECT f.id_corso_esame as corso, f.id_docente_esame as id_docente, d.nome as docente, d.cognome as cognome_docente, f.id_attdid_esame as id, ad.nome, f.ord_attdid_esame as ordinamento, a.data_svolgimento as \'data svolgimento\', a.data_fine as \'disponibile fino al\',
